...
# https://github.com/Li-Chongyi/Zero-DCE_extension/tree/main/Zero-DCE%2B%2B/data/test_data/real
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pretrain_dir", type=str, default="snapshots_Zero_DCE++/Epoch99.pth"
    )
